...
public class Constants
{
    ...
    public final static double quarterLength= SIZE*0.25;
    ...
    /////Color
    public final static Color shipP1_C = Color.white;
    public final static Color Asteroid_C = Color.white;
    public final static Color Alien_C = Color.YELLOW;
    public final static Color SAlien_C = Color.GREEN;
    public final static int Dust_Duration =500;
    public final static Color shipP2_C =Color.red;
}
