...
public abstract class Participant
{
    ...
    /**
     * Gets the the color of the participant
     */
    ...
    public void move ()
    {
        ...
        if(this instanceof asteroids.participantsEnhance.Ship)
        {
            double o= Math.tanh(image.getHeight()/(double)(image.getWidth()));
            //double r = Math.sqrt(Math.pow(image.getHeight()/2, 2)+Math.pow(image.getWidth()/2,2));
            double r = Math.hypot(image.getHeight()/2, image.getWidth()/2);
            System.out.println(o);
            System.out.println("ttt");
            at=AffineTransform.getTranslateInstance(x-r*Math.cos(o+rotation)    , y-r*Math.sin(o+rotation)    );
           // at=AffineTransform.getTranslateInstance(x-70    , y-43    );
            //at.scale(0.5, 0.5);
            at.rotate(rotation);
        }
